...
"use strict";
function e(e){
var r=e.length,n=e.indexOf("?"),t=e.indexOf("#");
t=-1==t?r:t,n=-1==n?t:n;
var s=e.substr(0,n),a=e.substr(n+1,t-n-1),i=e.substr(t+1);
return{
host:s,
query_str:a,
hash:i
...
function r(r,n){
var t=e(r),s=t.query_str,a=[];
for(var i in n)n.hasOwnProperty(i)&&a.push(i+"="+encodeURIComponent(n[i]));
return a.length>0&&(s+=(""!=s?"&":"")+a.join("&")),t.host+(""!=s?"?"+s:"")+(""!=t.hash?"#"+t.hash:"");
}
function n(e,r,n,t){
e=e||location.href;
var s=e.indexOf("&"),a=e.length,i=e.replace(/^[\w\d]+:[\/\\]+/g,"").split("").reverse(),o=a-1-i.indexOf("/");
-1!=s&&-1==e.indexOf("?")&&s>o&&(e=e.replace("&","?"));
var u=new RegExp("([\\?&]"+r+"=)[^&#]*");
return e.match(u)?t===!0?e.replace(u,"$1"+n):e:-1==e.indexOf("?")?e+"?"+r+"="+n:e+"&"+r+"="+n;
}
return{
parseUrl:e,
join:r,
