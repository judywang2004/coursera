...
var B=e.appmsgstat||{};
window.appmsgstat||(window.appmsgstat=B),B.show&&(!function(){
var e=document.getElementById("js_read_area3"),t=document.getElementById("like3");
e.style.display="block",t.style.display="inline",B.liked&&Class.addClass(t,"praised"),
t.setAttribute("like",B.liked?"1":"0");
var i=document.getElementById("likeNum3"),r=document.getElementById("readNum3"),a=B.read_num,n=B.like_num;
