...
"use strict";
function ad_click(e,t,a,i,o,r,n,p,s,d,_,l,c,m){
if(!has_click[o]){
has_click[o]=!0;
...
if(has_click[o]=!1,u&&(u.style.display="none"),"5"==e)location.href="/mp/profile?source=from_ad&tousername="+t+"&ticket="+r+"&uin="+uin+"&key="+key+"&__biz="+biz+"&mid="+mid+"&idx="+idx+"&tid="+o;else{
...
e.err_msg&&-1!=e.err_msg.indexOf("ok")||(location.href="http://"+location.host+"/mp/ad_redirect?url="+encodeURIComponent(t)+"&ticket="+r+"&uin="+uin);
}),!1;
}
...
if(o){
for(var r=o.adData,n=o.a_info,p=n.pos_type,s=o.ad_engine,d=0,_=i.length;_>d;++d)!function(e,t){
var a=i[e],o=a.dataset;
if(o){
var r=o.type,n=o.url,d=o.rl,_=o.apurl,l=o.tid,c=o.ticket,m=o.group_id,u=o.aid,g=o.pt;
...
ad_click(r,n,d,_,l,c,m,u,g,p,s,t,i,o),!1;
}
},!0);
}
}(d,r);
if(r){
r.adid=window.adid||r.adid;
var l="&tid="+r.traceid+"&uin="+uin+"&key="+key+"&ticket="+(r.ticket||"")+"&__biz="+biz+"&source="+source+"&scene="+scene+"&appuin="+biz+"&aid="+r.adid+"&ad_engine="+s+"&pos_type="+p+"&r="+Math.random();
if(r.report_param=l,"100"==r.pt){
...
if("102"==r.pt){
var m=require("a/android.js"),u=15,g=r.pkgname&&r.pkgname.replace(/\./g,"_");
return void new m({
btn:document.getElementById("js_app_action_"+p),
adData:r,
report_param:l,
task_ext_info:[r.adid,r.traceid,g,source,u,s].join("."),
via:[r.traceid,r.adid,g,source,u,s].join(".")
});
}
if("101"==r.pt){
...
if("103"==r.pt||"104"==r.pt){
var y=require("a/gotoappdetail.js"),u=15,g=r.pkgname&&r.pkgname.replace(/\./g,"_");
return void new y({
...
via:[r.traceid,r.adid,g,source,u,s].join("."),
ticket:r.ticket,
appdetail_params:["&aid="+r.adid,"traceid="+r.traceid,"pkgname="+g,"source="+source,"type="+u,"engine="+s,"appuin="+biz,"pos_type="+p,"ticket="+r.ticket,"scene="+scene].join("&")
});
}
if("105"==r.pt)return void new Card({
btn:document.getElementById("js_card_action_"+p),
adData:r,
report_param:l,
pos_type:p
});
if("106"==r.pt)return void new MpShop({
